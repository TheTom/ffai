...
//
// GGUF embeds the tokenizer alongside the model weights via the
// canonical GGUF v3 metadata schema. The
...
enum GGUFTokenizerAdapter {
    ...
    static func build(reader: GGUFReader) throws -> any Tokenizer {
        ...
        // GGUF carries upstream-side regex-group names (`"joyai-llm"`,
    ...
    /// string in GGUF carries the upstream regex-family name
