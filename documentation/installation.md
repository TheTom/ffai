...
2. Enter `https://github.com/ekryski/FFAI` and pick a version / branch.
...
[`metaltile`](https://github.com/ekryski/metaltile) checkout (the
Rust DSL that compiles kernels) and Cargo:

```bash
git clone https://github.com/ekryski/FFAI
git clone https://github.com/ekryski/metaltile
cd FFAI
