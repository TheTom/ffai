...
fn siglip_vision_tower_vs_hf() {
    ...
    eprintln!("SigLIP vision tower on Metal: LHS[0,:5]={:?}", &lhs[..5]);
    ...
    eprintln!("✅ Full real SigLIP vision tower matches HF on the shared engine (Apple GPU) — VLM vision half verified.");
}
