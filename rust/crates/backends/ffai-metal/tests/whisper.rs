...
fn whisper_tiny_encoder_vs_hf() {
    ...
    eprintln!("Whisper-tiny encoder on Metal: ENC[0,:5]={:?}", &lhs[..5]);
    ...
    eprintln!("✅ Full real Whisper-tiny audio encoder matches HF on the shared engine (Apple GPU) — audio half verified.");
}
