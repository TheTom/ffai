...
//! Generic dense-LLM verification harness on Metal. Point MODEL_DIR at any
//! HF model dir (config.json + model.safetensors); load_hf derives the
//! config + arch flags, runs forward_single(TOK), and prints the argmax.
//! One code path for the whole Llama/Qwen/Mistral/Yi/Phi/SmolLM family.
//!
//!   MODEL_DIR=/path/to/model TOK=9707 EXPECT=21806 \
