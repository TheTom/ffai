// IQ2_XXS codebook (extracted from gguf-py). 256 entries x 8 int8.
pub(crate) static IQ2XXS_GRID: [[i8; 8]; 256] = [
    [8,8,8,8,8,8,8,8],
    [43,8,8,8,8,8,8,8],
    [25,25,8,8,8,8,8,8],
    [8,43,8,8,8,8,8,8],
